...
# **4\. 役割分担（Claude Code / Antigravity / GitHub）**

## **4.1 QA/Architect & Reviewer（例：Claude Code）**
...
* 定期メンテ起票と改善ループ運用
  ...
  ## **4.2 Executor（例：Antigravity）**

* Issueに従って実装/修正  
* テスト実行→コミット→PR（可能な範囲で自律）
...
Antigravityや“前に進みたい”モードはルール無視が起きる。  
